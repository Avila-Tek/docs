...
Los Blocs solo **deben** recibir [Casos de Uso](/docs/mobile/code-rules/domain/use-cases.md) para manejar la logica de negocio del feature, y **deben** ser asignados obligatoriamente a atributos privados dentro del Bloc.
